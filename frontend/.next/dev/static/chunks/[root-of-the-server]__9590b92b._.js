...
function Dashboard() {
    ...
    if ($[0] !== "4b031d133bdc8a7d25835e4c520c690e9657cb50a7f6dbfd1258639267eb9cb4") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4b031d133bdc8a7d25835e4c520c690e9657cb50a7f6dbfd1258639267eb9cb4";
    }
    ...
    if ($[3] !== dispatch || $[4] !== isTokenThere) {
        t1 = ({
            "Dashboard[useEffect()]": ()=>{
                if (isTokenThere) {
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$index$2e$jsx__$5b$client$5d$__$28$ecmascript$29$__["getAllPosts"])());
                }
            }
        })["Dashboard[useEffect()]"];
        $[3] = dispatch;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9590b92b._.js.map