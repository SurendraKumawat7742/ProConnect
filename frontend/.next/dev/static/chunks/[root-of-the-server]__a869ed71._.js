...
function DashboardLayout(t0) {
    ...
    if ($[0] !== "d1d2ccca0dba0f9832eba5f56531ca4e5bd02fd8b3823e767f006f56bdd57299") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d1d2ccca0dba0f9832eba5f56531ca4e5bd02fd8b3823e767f006f56bdd57299";
    }
    const { children } = t0;
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
function Dashboard() {
    ...
    if ($[0] !== "53732033db5a1e680f9eb034cab73e0513798b1805be7a9da1c1237df59b75dd") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "53732033db5a1e680f9eb034cab73e0513798b1805be7a9da1c1237df59b75dd";
    }
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
...
_s(Dashboard, "RcFfM4+a+3C3Q4Yt7sz1UQfBrbY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a869ed71._.js.map