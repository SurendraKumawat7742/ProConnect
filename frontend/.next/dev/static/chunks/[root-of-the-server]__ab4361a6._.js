...
function ViewProfilePage(t0) {
    ...
    if ($[0] !== "2ffdad26a730b27c945a20b8aef31e410044531c097e74497d37c6fe4064d15b") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2ffdad26a730b27c945a20b8aef31e410044531c097e74497d37c6fe4064d15b";
    }
    ...
    const t1 = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$index$2e$jsx__$5b$client$5d$__$28$ecmascript$29$__["BASE_URL"]}/${userProfile.backDrop}`;
    let t2;
    if ($[1] !== t1) {
...
_s(ViewProfilePage, "FVKBcJnHQg4RZa5ycC8utU9iu5w=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab4361a6._.js.map